...
public class BroadcastServiceTest {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty(IOSystemProperties.Net.Http.DEFAULT_CLIENT_READ_TIMEOUT, "60000");
        System.setProperty(IOSystemProperties.Net.Http.OUTPUT_LOG_BODY_MAX_LENGTH, Integer.toString(Integer.MAX_VALUE));
