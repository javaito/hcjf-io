...
public final class Cloud extends Service<CloudConsumer> {
     ...
     */
    private Cloud() {
        super(SystemProperties.get(IOSystemProperties.Cloud.SERVICE_NAME),
                SystemProperties.getInteger(IOSystemProperties.Cloud.SERVICE_PRIORITY));
        String implClassName = SystemProperties.get(IOSystemProperties.Cloud.IMPL);
