        ...
        try {
            switch (queryable.getResourceName()) {
                ...
                case NAMESPACED_CONFIG_MAP: {
                    for(V1ConfigMap configMap : api.listNamespacedConfigMap(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null, null, null, null, null, null, null, null, false).getItems()) {
                        result.add(new JoinableMap(Introspection.toMap(configMap, consumer)));
                    }
                    break;
                ...
                case NAMESPACED_END_POINT: {
                    for(V1Endpoints endpoints : api.listNamespacedEndpoints(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                        result.add(new JoinableMap(Introspection.toMap(endpoints, consumer)));
                    }
                    break;
                ...
                case NAMESPACED_EVENT: {
                    for(CoreV1Event event : api.listNamespacedEvent(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                        result.add(new JoinableMap(Introspection.toMap(event, consumer)));
                    }
                    break;
                ...
                case LIMIT_RANGE: {
                    for(V1LimitRange limitRange : api.listNamespacedLimitRange(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                ...
                case PERSISTENT_VOLUME_CLAIM: {
                    for(V1PersistentVolumeClaim persistentVolumeClaim : api.listNamespacedPersistentVolumeClaim(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                ...
                case NAMESPACED_POD: {
                    for(V1Pod pod : api.listNamespacedPod(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                        result.add(new JoinableMap(Introspection.toMap(pod, consumer)));
                    }
                    break;
                ...
                case POD_TEMPLATE: {
                    for(V1PodTemplate podTemplate : api.listNamespacedPodTemplate(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                ...
                case REPLICATION_CONTROLLER: {
                    for(V1ReplicationController replicationController : api.listNamespacedReplicationController(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                ...
                case NAMESPACED_RESOURCE_QUOTA: {
                    for(V1ResourceQuota resourceQuota : api.listNamespacedResourceQuota(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                        result.add(new JoinableMap(Introspection.toMap(resourceQuota, consumer)));
                    }
                    break;
                ...
                case NAMESPACED_SECRET: {
                    for(V1Secret secret : api.listNamespacedSecret(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                        result.add(new JoinableMap(Introspection.toMap(secret, consumer)));
                    }
                    break;
                ...
                case NAMESPACED_SERVICE_ACCOUNT: {
                    for(V1ServiceAccount serviceAccount : api.listNamespacedServiceAccount(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                        result.add(new JoinableMap(Introspection.toMap(serviceAccount, consumer)));
                    }
                    break;
                ...
                case NAMESPACED_SERVICE: {
                    for(V1Service service : api.listNamespacedService(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE),
                            null, null,null,null,null,null,null,null, null, false).getItems()) {
                        result.add(new JoinableMap(Introspection.toMap(service, consumer)));
                    }
                    break;
                ...
                case POD_METRICS: {
                    PodMetricsList podMetricsList = metrics.getPodMetrics(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE));
                ...
                case NAMESPACED_DEPLOYMENT: {
                    for(V1Deployment deployment : appsApi.listNamespacedDeployment(SystemProperties.get(IOSystemProperties.Cloud.Orchestrator.Kubernetes.NAMESPACE)
                            , null, null,null,null,null,null,null, null, null, false).getItems()) {
