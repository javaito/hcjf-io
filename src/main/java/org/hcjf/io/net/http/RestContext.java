...
public class RestContext extends Context {
    ...
    private static class RequestModel {
        ...
        public RequestModel(Queryable.DataSource contextDataSource, JsonObject jsonObject, Object instanceId) {
            if(!jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.BODY_FIELD)) &&
                    !jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.QUERY_FIELD)) &&
                    !jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.QUERIES_FIELD)) &&
                    !jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.COMMAND_FIELD)) &&
                    !jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.COMMANDS_FIELD))) {
                body = JsonUtils.createBody(jsonObject);
            } else {
                if (jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.BODY_FIELD))) {
                    body = JsonUtils.createBody(jsonObject.getAsJsonObject(SystemProperties.get(IOSystemProperties.Net.Rest.BODY_FIELD)));
                }

                if (jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.QUERY_FIELD))) {
                    queryable = (Queryable) createQuery(jsonObject.get(SystemProperties.get(IOSystemProperties.Net.Rest.QUERY_FIELD)));
                }

                if (jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.QUERIES_FIELD))) {
                    pointers = new HashMap<>();
                    queryables = new HashMap<>();
                    JsonObject queryablesObject = jsonObject.getAsJsonObject(SystemProperties.get(IOSystemProperties.Net.Rest.QUERIES_FIELD));
                ...
                if (jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.DATA_SOURCE_FIELD))) {
                    Map<String, Object> rawDataSources = (Map<String, Object>)
                            JsonUtils.createObject(jsonObject.get(
                                    SystemProperties.get(IOSystemProperties.Net.Rest.DATA_SOURCE_FIELD)));
                ...
                if (jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.COMMANDS_FIELD))) {
                    commands = new ArrayList<>();
                    JsonArray commandsJson = jsonObject.getAsJsonArray(SystemProperties.get(IOSystemProperties.Net.Rest.COMMANDS_FIELD));
                ...
                if (jsonObject.has(SystemProperties.get(IOSystemProperties.Net.Rest.COMMAND_FIELD))) {
                    JsonElement commandJson = jsonObject.get(SystemProperties.get(IOSystemProperties.Net.Rest.COMMAND_FIELD));
                    try {
