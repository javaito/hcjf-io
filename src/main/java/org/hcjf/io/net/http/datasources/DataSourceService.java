...
public final class DataSourceService extends Service<DataSourceServiceConsumer> {
    ...
    private DataSourceService() {
        super(SystemProperties.get(IOSystemProperties.Net.Http.DataSources.SERVICE_NAME),
                SystemProperties.getInteger(IOSystemProperties.Net.Http.DataSources.SERVICE_PRIORITY));
    ...
    public void registerConsumer(DataSourceServiceConsumer consumer) {
        ...
        Boolean threadPoolEnabled = SystemProperties.getBoolean(IOSystemProperties.Net.Http.DataSources.THREAD_POOL_ENABLED);
