...
public class HttpRequest extends HttpPackage {
        ...
        for(String param : params) {
            ...
            if(key.contains(Strings.START_SUB_GROUP) && key.contains(Strings.END_SUB_GROUP)) {
                ...
                try {
                    ...
                    Log.w(SystemProperties.get(IOSystemProperties.Net.Http.LOG_TAG), "Unable to decode http parameter, %s:%s", key, value);
    ...
    public String toString() {
        ...
        if(getBody() != null) {
            int maxLength = SystemProperties.getInteger(IOSystemProperties.Net.Http.INPUT_LOG_BODY_MAX_LENGTH);
            if(maxLength > 0) {
