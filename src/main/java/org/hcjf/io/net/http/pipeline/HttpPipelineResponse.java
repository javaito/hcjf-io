...
public abstract class HttpPipelineResponse extends HttpResponse {
     ...
     * @return Returns true if the first read operation and false in otherwise.
     */
     ...
     * side of the pipeline and wrap these bytes depends on the
     * result encoding.
    ...
    /**
     * Return the buffer, this method must be called before the read method.
    ...
    /**
     * This method must implement the way to read the information from the
     * application source.
    ...
    protected final class StreamingPackage {
         ...
         * @param propertyName Property name.
         * @return True if the property is contained and false in otherwise.
         */
